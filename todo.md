...
- [x] Implementar interface de convites por email na aba Configurações ✅
- [x] Implementar modal de aceitar regulamento no primeiro acesso ✅ (já existia)
- [x] Integrar fluxo de convites com validação de regulamento ✅
- [x] Adicionar geração de token único para convites ✅
- [x] Implementar envio de email com link de convite ✅
- [x] Criar página de aceitação de convite e criação de conta ✅
- [x] Integrar fluxo: convite -> criação de conta -> aceitar regulamento ✅
- [x] Testar fluxo completo de convite e regulamento ✅
- [x] Adicionar opção de deletar convites ✅
- [x] Testar deleção de convites ✅
- [x] Implementar link de convite público (/join/:code) ✅
- [x] Testar link de convite público ✅
- [x] Corrigir link para usar domínio customizado (sem Manus) ✅
- [x] Preparar projeto para Railway ✅
- [x] Criar arquivo railway.json ✅
- [x] Criar .railwayignore ✅
- [x] Atualizar link de convite para usar domínio temporário ✅
- [ ] Usuário conectar repositório GitHub ao Railway (RESPONSABILIDADE DO USUÁRIO)
- [ ] Usuário configurar variáveis de ambiente no Railway (RESPONSABILIDADE DO USUÁRIO)
- [ ] Usuário fazer deploy no Railway (RESPONSABILIDADE DO USUÁRIO)
