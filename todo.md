...
## Novas regras financeiras solicitadas (2026-05-18) - TODAS EDITÁVEIS

- [ ] Adicionar campos de configuração no appSettings para todas as regras financeiras
- [ ] Valor da mensalidade mensal (editável, padrão: R$0)
- [ ] Multa por cartão amarelo (editável, padrão: R$10)
- [ ] Multa por cartão vermelho (editável, padrão: R$50)
- [ ] Multa por falta sem aviso (editável, padrão: R$5)
- [ ] Toggle para ativar/desativar cada regra
- [ ] Implementar mutations para criar débitos e multas
- [ ] Criar UI administrativa para editar regras financeiras
- [ ] Implementar job automático de mensalidade no 1º do mês
- [ ] Criar UI para visualizar débitos por jogador
